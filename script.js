...
(function () {
  ...
  var I18N = {
    ...
    kk: {
      ...
      hero_trust2: 'жыл — басшының Қазақстан туризм саласындағы тәжірибесі',
      hero_trust3: 'Kazakh Tourism-нің «Сапа белгісі» белгісі',
      ...
      tr_price3_v: '6-ға дейін', tr_price3_l: 'адамнан тұратын топтар',
      tr_partner: 'TAMYR этноорталығымен бірлесіп. Жайлылықпен саяхатта!',
      tr_cta: 'Трансферді талқылау',
      et_kicker: 'Туризм · 05', et_title: 'Этномәдени бағдарламалар',
      et_lead: 'Ұлы даланың дәстүрлері — көз алдыңызда: киіз үй мен шаңырақ, домбыра, бауырсақтан бешбармаққа дейінгі ұлттық ас, қолөнер мен қонақжайлылық салттары.',
      et_chip1: 'Дәстүрлер мен салттар', et_chip2: 'Ұлттық ас', et_chip3: 'Қолөнер және шеберлік сабақтары',
      ...
      edu_stat2: 'білікті маман даярланып шығарылды',
      ...
      edu4_title: 'Алғашқы дәрігерге дейінгі көмек',
      ...
      why_kicker: 'Сенім', why_title: 'DUAL.KZ-ті неге таңдайды',
      ...
      why_sapa_title: '«Сапа белгісі» сапа белгісі',
      why_sapa_text: '«Kazakh Tourism» ҰК» АҚ-ның «Сапа белгісі» бағдарламасының мемлекеттік ерекшелік белгісі, ҚР Туризм және спорт министрлігінің қолдауымен — «Оқу орны» санатында.',
      ...
      why3_text: 'Қазақстан гидтерінің кәсіби қауымдастығында жұмыс істейміз — KazGuides және TAMYR этноорталығымен бірге.',
      why4_title: 'Үш тіл',
      why4_text: 'Қазақ, орыс және ағылшын тілдеріндегі экскурсиялар мен ілесіп жүру.',
      why5_title: 'Қонақтардың қауіпсіздігі',
      why5_text: 'Алғашқы дәрігерге дейінгі көмек — жұмыс стандартымыздың бөлігі және өз тренингтеріміздің тақырыбы.',
      rev_title: 'Туристер мен түлектердің пікірлері',
      rev_text: 'Қонақтарымыз бен түлектеріміздің шынайы әсерлерін жинап жатырмыз — жақында олар осында пайда болады. Әзірге Instagram-ға қараңыз: онда саяхаттар нақты уақытта өтіп жатыр.',
      ...
      ab_text2: 'Сондықтан біз — DUAL: бір істің екі бағыты. Елді қонақтарға көрсету — және оны кәсіби түрде көрсетуге үйрету. Компания басшысы Қазақстан туризм саласына 35 жылдан астам уақытын арнады.',
      ...
      cf_name: 'Есіміңіз', cf_name_ph: 'Сізге қалай жүгінейік?',
      cf_topic: 'Тақырып',
