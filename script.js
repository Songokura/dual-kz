...
(function () {
  ...
  var I18N = {
    ru: {
      ...
      dir2_title: 'Обучение',
      dir2_text: 'Подготовка и повышение квалификации гидов и экскурсоводов, тренинги по первой помощи, курсы трансферных сопровождающих, программы для туроператоров и турагентов.',
      ...
      edua_title: 'Курсы гидов и экскурсоводов в Астане',
      ...
      edua_b1_d: 'Короткий курс вместо долгого обучения: вход в профессию стоит дешевле, чем кажется. Стоимость и график — по запросу.',
      ...
      edua_cta: 'Записаться на курс в Астане',
      ...
      edu6_title: 'Тренинги для туроператоров и турагентов',
      edu6_text: 'Корпоративные программы для команд туркомпаний и турагентств: сервис, приём гостей, стандарты отрасли.',
    ...
    kk: {
      ...
      hero_cta1: 'Тур таңдау', hero_cta2: 'Астанадағы гид курстары',
      ...
      dir2_title: 'Оқыту',
      dir2_text: 'Гидтер мен экскурсоводтарды даярлау және біліктілігін арттыру, алғашқы көмек тренингтері, трансферлік ілесушілер курстары, туроператорлар мен турагенттерге арналған бағдарламалар.',
      ...
      edua_title: 'Астанадағы гид және экскурсовод курстары',
      ...
      edua_b1_d: 'Ұзақ оқудың орнына қысқа курс: кәсіпке кіру ойлағаннан арзанырақ. Құны мен кестесі — сұраныс бойынша.',
      ...
      edua_b3_t: 'Курстан кейінгі жұмыс',
      ...
      edua_cta: 'Астанадағы курсқа жазылу',
      ...
      edu6_title: 'Туроператорлар мен турагенттерге тренингтер',
      edu6_text: 'Туристік компаниялар мен турагенттіктер командаларына арналған корпоративтік бағдарламалар: сервис, қонақ қабылдау, сала стандарттары.',
    ...
    en: {
      ...
      hero_cta1: 'Find my tour', hero_cta2: 'Guide courses in Astana',
      ...
      dir2_title: 'Training',
      dir2_text: 'Training and professional development for guides, first-aid workshops, transfer escort courses and programmes for tour operators and travel agents.',
      ...
      edua_b3_t: 'Work after the course',
      ...
      edua_cta: 'Enrol on a course in Astana',
      ...
      edu6_title: 'For tour operators and travel agents',
      edu6_text: 'Corporate programmes for travel company and travel agency teams: service, guest experience, industry standards.',
      ...
      team_lead: 'Our excursions and courses are run by working professionals — guides, national trainers and practitioners who lead groups themselves.',
