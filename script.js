...
(function () {
  ...
  var I18N = {
    ru: {
      ...
      pr_bonus_t: 'Специальный бонус',
      pr_bonus_d: 'Первым пяти оплатившим — 6 месяцев регистрации в ассоциации KazGuides в подарок.',
    ...
    kk: {
      ...
      pr_bonus_t: 'Арнайы бонус',
      pr_bonus_d: 'Алғашқы бес төлеушіге — KazGuides қауымдастығындағы 6 айлық тіркеу сыйға тартылады.',
    ...
    en: {
      ...
      pr_bonus_t: 'Special bonus',
      pr_bonus_d: 'The first five people to pay receive six months of KazGuides association membership as a gift.',
